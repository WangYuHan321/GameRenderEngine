...
public:
    ...
    void SetVector(std::string location, Vector2 value);
    void SetVector(std::string location, Vector3  value);
    void SetVector(std::string location, Vector4  value);
    void SetVector(std::string location, IVector2  value);
    void SetVector(std::string location, IVector3  value);
    void SetVector(std::string location, IVector4  value);
    void SetVector(std::string location, Color3 value);
    void SetVector(std::string location, Color4 value);
    void SetMatrix(std::string location, Matrix2 value);
    void SetMatrix(std::string location, Matrix3 value);
    void SetMatrix(std::string location, Matrix4 value);
